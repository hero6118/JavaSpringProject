...
<link href="<c:url value="/acssets/user/css/open-iconic-bootstrap.min.css" />" rel="stylesheet" />

<link href="<c:url value="/acssets/user/css/animate.css" />" rel="stylesheet" />

<link href="<c:url value="/acssets/user/css/owl.carousel.min.css" />" rel="stylesheet" />

<link href="<c:url value="/acssets/user/css/owl.theme.default.min.css" />" rel="stylesheet" />

<link href="<c:url value="/acssets/user/css/magnific-popup.css" />" rel="stylesheet" />

<link href="<c:url value="/acssets/user/css/aos.css" />" rel="stylesheet" />

<link href="<c:url value="/acssets/user/css/ionicons.min.css" />" rel="stylesheet" />

<link href="<c:url value="/acssets/user/css/bootstrap-datepicker.css" />" rel="stylesheet" />
<
<link href="<c:url value="/acssets/user/css/jquery.timepicker.css" />" rel="stylesheet" />


<link href="<c:url value="/acssets/user/css/flaticon.css" />" rel="stylesheet" />
<link href="<c:url value="/acssets/user/css/icomoon.css" />" rel="stylesheet" />
<link href="<c:url value="/acssets/user/css/style.css" />" rel="stylesheet" />
</head>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
					<div class="product d-flex flex-column">
						<a href="#" class="img-prod"><img class="img-fluid"
							src="images/product-2.png" alt="Colorlib Template"> <span
				...
				<div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
					<div class="product">
						<a href="#" class="img-prod"><img class="img-fluid"
							src="images/product-7.png" alt="Colorlib Template">
							<div class="overlay"></div> </a>
						<div class="text py-3 pb-4 px-3">
							<div class="d-flex">
								<div class="cat">
				...
				<div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
					<div class="product">
						<a href="#" class="img-prod"><img class="img-fluid"
							src="images/product-8.png" alt="Colorlib Template">
							<div class="overlay"></div> </a>
						<div class="text py-3 pb-4 px-3">
							<div class="d-flex">
								<div class="cat">
